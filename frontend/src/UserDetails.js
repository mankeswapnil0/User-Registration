...
function UserDetails() {
  ...
  const deleteUser = async(id) => {
    const deleteurl = `http://localhost:4000/api/v1/user/delete/${id}`
  ...
  return (
    <div>
      {user && user.map((elem) => (
        ...
        <CardActions>
          <Button onClick={() => handleEdit(elem._id)} size="small">Edit</Button>
          <Button onClick={() => deleteUser(elem._id)} size="small">Delete</Button>
        </CardActions>
      </Card>
      ))}
    </div>
